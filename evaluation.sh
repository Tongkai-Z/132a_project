#!/bin/bash
#Run this script for automatic evaluation
...
echo sbert_dot
python search.py --index_name wapo_docs_50k --topic_id $topic --query_type $qt --vector_name sbert_dot_product_vector --top_k 20 -q
